# Evening Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Evening is a Latin (ID: `*Latn`) based Sans Serif font designed by
[Bryce Wilner](http://www.brycewilner.com). the characters are all in 1 weight
loosely drawn from the cover of Ian Hamilton Finlay's
*Evening Will Come They Will Sew the Blue Sail
(New York and Los Angeles: DAP, 1991)*. Its minimalistic and slim design
provides a luxurious feeling.

This font is ideal for inviting text display for both eye-catching heading and
body text like name card, evening function invite card, website heading, etc.
...
```
Title: Evening Font
Creators: Bryce Wilner
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-evening
UUID: FB95A861-42B1-4D49-9CE3-2955F91603A8
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-evening
```
